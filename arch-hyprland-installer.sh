...
install_aur_packages() {
    ...
    for pkg in hyprland hyprutils hyprlang hyprcursor hyprwayland-scanner aquamarine hyprwire hyprgraphics; do sudo pacman -Rdd --noconfirm $pkg 2>/dev/null || true; done
